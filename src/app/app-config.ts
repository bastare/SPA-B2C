...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority:
        'https://udscustomersdirectory.b2clogin.com/tfp/udscustomersdirectory.onmicrosoft.com/B2C_1_signupsignin'
    },
    resetPassword: {
      authority:
        'https://udscustomersdirectory.b2clogin.com/tfp/udscustomersdirectory.onmicrosoft.com/B2C_1_PasswordReset'
    }
  }
};
// #endregion
